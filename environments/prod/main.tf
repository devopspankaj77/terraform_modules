# =============================================================================
# Production Environment — Same structure as dev (rg, vnets, vms, for_each modules)
# =============================================================================
# Uses the same variable layout and module pattern as dev. Set prod-specific
# values in prod.tfvars per SECURITY_BASELINES.md (e.g. restrict RDP/SSH source).
# Provider/version: see providers.tf.
# =============================================================================
...
# Assign VM Admin Login for vm-app
...
# Assign VM Admin Login for vm-jump (RDP/SSH via Azure AD)
